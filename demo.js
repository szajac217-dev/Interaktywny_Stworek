(() => {
  ...
  const posters = {
    wystawa: {
      eyebrow: 'JOANNA TURKIEWICZ–DĄBROWSKA',
      title: 'PRZE<br>CI<br>WIEŃ<br>STWA',
      subtitle: 'WYSTAWA MALARSTWA',
      details: 'Wystawa czynna 17 maja – 12 lipca<br>Dom Carla i Gerharta Hauptmannów'
    },
    koncert: {
      eyebrow: 'LETNIE BRZMIENIA',
      title: 'KON<br>CERT<br>NA<br>ŻYWO',
      subtitle: 'MUZYKA • EMOCJE • ENERGIA',
      details: 'Sobota, godz. 19:00<br>Skwer Radiowej Trójki'
    },
    rodzinne: {
      eyebrow: 'WSPÓLNY CZAS',
      title: 'PIK<br>NIK<br>RO<br>DZINNY',
      subtitle: 'ZABAWA DLA MAŁYCH I DUŻYCH',
      details: 'Niedziela, godz. 12:00<br>Wstęp wolny'
    },
    kino: {
      eyebrow: 'KINO ZA ROGIEM',
      title: 'SE<br>ANS<br>FIL<br>MOWY',
      subtitle: 'DUŻE EMOCJE NA MAŁEJ SALI',
      details: 'Piątek, godz. 18:00<br>Liczba miejsc ograniczona'
    },
    sport: {
      eyebrow: 'KARKONOSKA PRZYGODA',
      title: 'ROW<br>ER<br>I<br>GÓRY',
      subtitle: 'ADRENALINA I DOBRA ZABAWA',
      details: 'Start o godz. 10:00<br>Trasa rodzinna i sportowa'
    },
    warsztaty: {
      eyebrow: 'PRACOWNIA TWÓRCZA',
      title: 'ZRÓB<br>TO<br>SAM',
      subtitle: 'WARSZTATY DLA KAŻDEGO',
      details: 'Zapisy w MOKSiAL<br>Materiały zapewnia organizator'
    }
  };
  ...
  function updateClock() {
    const now = new Date();
    document.querySelector('#clock').textContent = now.toLocaleTimeString('pl-PL', {
      hour: '2-digit',
      minute: '2-digit'
    });
    document.querySelector('#date').textContent = now.toLocaleDateString('pl-PL', {
      weekday: 'short',
      day: '2-digit',
      month: '2-digit',
      year: 'numeric'
  ...
  setTimeout(() => mascot.lean('right'), 900);
})();
